...
Color.prototype = {
    ...
    toRGBA: function () {
        var self = this;
        return 'rgba(' + self.getR() + ', ' + self.getG() +
            ', ' + self.getB() + ', ' + self.getA() + ')';
    },
    /**
    ...
    toHex: function () {
        var self = this;
        return '#' + padding2(Number(self.getR()).toString(16)) +
            padding2(Number(self.getG()).toString(16)) + padding2(Number(self.getB()).toString(16));
    },
    /**
